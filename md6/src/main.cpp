...
std::string md6SequentialHash(const char *inputS, int hashBitLen) {
...
int main() {
    std::string hash128 = md6SequentialHash("test", 128);
    std::string hash256 = md6SequentialHash("test", 256);
    std::string hash512 = md6SequentialHash("test", 512);
